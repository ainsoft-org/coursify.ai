						...
						<div className="flex justify-between md:space-x-4 space-x-0 space-y-4 md:space-y-0 md:flex-row flex-col">
							...
							>
								...
								<p className="lg:text-2xl text-[18px] leading-[29px] text-[#D6D6D6] font-inter font-normal">
									...
									courses. The AI-generated content adapts to my students needs,
									making learning more engaging and enjoyable. I have seen a
									noticeable improvement in knowledge retention and overall
									success.
								</p>
							</div>
							<div
							...
							>
								...
								<p className="lg:text-2xl text-[18px] leading-[29px] text-[#D6D6D6]  font-inter font-normal">
									I&apos;ve tried multiple course creation platforms, but
									Coursify.AI stands out for its powerful analytics and
									insights. The data-driven approach has enabled me to optimize
									my courses and achieve better learning outcomes for my
