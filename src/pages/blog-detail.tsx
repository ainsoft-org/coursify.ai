        ...
        <section className="w-full blog-hero-section lg:pb-24 lg:pt-[324px] pt-[150px] pb-[50px] relative bg-[#0D0D0D] overflow-hidden text-center lg:text-left">
          <div className="max-w-[1352px] mx-auto flex flex-col items-center justify-center px-4 relative z-[1] text-center">
            <div className='max-w-[700px]'>
              <h1 className='text-white font-unbounded font-bold lg:text-[56px] text-4xl lg:leading-[69px] mb-6 text-left'>10 Secrets for managing a remote team </h1>
              <div className='flex items-center'>
                <Image
                  ...
                  height={56}
                />
                <p className='font-mulish text-[#6D7D8B] text-sm font-semibold'>Shedrack eze</p>
                <div className='font-mulish text-[#6D7D8B] text-sm font-semibold mx-6'>I</div>
                <p className='font-mulish text-[#6D7D8B] text-sm font-semibold'>2nd January,2022</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[1352px] mx-auto px-4">
            <div className='max-w-[900px] mx-auto'>
              ...
              <div className='sm:my-24 my-16 flex items-center justify-center'>
                ...
                />
                <div>
                  <p className='font-inter text-[#BDC7E1] font-semibold leading-[21.08px] text-sm'>Written by</p>
                  <p className='font-inter text-[#C3CFDA] font-normal leading-[29px] text-2xl my-[5px]'>Shedrack Eze</p>
                  <p className='font-inter text-[#989898] font-semibold leading-[21.08px] text-sm'>CEO Team App</p>
                </div>
              </div>
              <div className='max-w-[700px] h-px mx-auto' style={{ background: 'rgba(109, 125, 139, 0.22)' }}></div>
            </div>
          </div>
        </section>
        <Footer />
